            ...
            <nav>\
                <ul class="nav nav-pills nav-top">\
                    ...
                    <li>\
                      ...
                      <li>\
                        <a href="/B/' + countryPrefix + '/memberResetPassword.html">Change Password</a>\
                    </li>\
                    <li>\
            ...
            <nav>\
                <ul class="nav nav-pills nav-top">\
                    ...
                    <li>\
                       ...
                       <li>\
                    <a href="/B/' + countryPrefix + '/changePassword.html"><i class="icon icon-lock"></i>Change Password</a>\
                    </li>\
                    <li>\
 ...
 <!-- Showroom Dropdown -->\
                ...
                <li class="dropdown">\
                    ...
                    <ul class="dropdown-menu">\
                        <li><a href="/B/' + countryPrefix + '/showroom.html?name=BathRoom"><i class="icon icon-map-marker"></i> Bathroom</a></li>\
                        <li><a href="/B/' + countryPrefix + '/showroom.html?name=BedRoom"><i class="icon icon-map-marker"></i> Bedroom</a></li>\
                        <li><a href="/B/' + countryPrefix + '/showroom.html?name=ChildRoom"><i class="icon icon-map-marker"></i> Childroom</a></li>\
                        <li><a href="/B/' + countryPrefix + '/showroom.html?name=LivingRoom"><i class="icon icon-map-marker"></i> Livingroom</a></li>\
                        <li><a href="/B/' + countryPrefix + '/showroom.html?name=Study"><i class="icon icon-map-marker"></i> Study</a></li>\
                    </ul>\
                </li>\
\
                <!-- Virtual Store Link -->\
