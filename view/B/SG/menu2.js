            ...
            <nav class="nav-main mega-menu">\
                <ul class="nav nav-pills nav-main" id="mainMenu">\
                  <li class="dropdown">\
                        ...
                        <li><a href="/B/' +
    countryPrefix +
    '/showroom.html?name=BathRoom"><i class="icon icon-map-marker"></i> Bathroom</a></li>\
                        <li><a href="/B/' +
    countryPrefix +
    '/showroom.html?name=BedRoom"><i class="icon icon-map-marker"></i> Bedroom</a></li>\
                        <li><a href="/B/' +
    countryPrefix +
    '/showroom.html?name=ChildRoom"><i class="icon icon-map-marker"></i> Childroom</a></li>\
                        <li><a href="/B/' +
    countryPrefix +
    '/showroom.html?name=LivingRoom"><i class="icon icon-map-marker"></i> Livingroom</a></li>\
                        <li><a href="/B/' +
    countryPrefix +
    '/showroom.html?name=Study"><i class="icon icon-map-marker"></i> Study</a></li>\
                    </ul>\
                    </li>\
                    <li>\
                        <a href="/B/' +
